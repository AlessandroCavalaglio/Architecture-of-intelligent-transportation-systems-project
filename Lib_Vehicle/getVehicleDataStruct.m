...
[tyre_data_f,tyre_data_r] = load_MF96_tyre_data();
...
vehicle.L     = Lf + Lr;   % [m] Vehicle wheelbase  
vehicle.hGs   = 0.45;   % [m] CoM vertical position  
vehicle.Wf    = 1.85;   % [m] Front track width     
vehicle.Wr    = 1.85;   % [m] Rear track width  
